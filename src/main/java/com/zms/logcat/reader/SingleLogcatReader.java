...
import com.zms.logcat.helper.LogcatHelper;
import com.zms.logcat.helper.RuntimeHelper;
import com.zms.logcat.helper.VersionHelper;
...
public class SingleLogcatReader extends AbsLogcatReader {
    ...
    private void init() throws IOException {
        ...
        logcatProcess = LogcatHelper.getLogcatProcess(logBuffer); //获得命令参数 并执行

        bufferedReader = new BufferedReader(new InputStreamReader(logcatProcess
                .getInputStream()), 8192); //获得输出流
    }
