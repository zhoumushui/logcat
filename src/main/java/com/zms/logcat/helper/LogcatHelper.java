...
public class LogcatHelper {
	...
	public static Process getLogcatProcess(String buffer) throws IOException { //获得logcat的进程 并执行
	...
	private static List<String> getLogcatArgs(String buffer) { //没有格式选项 默认是为time   获得命令参数
